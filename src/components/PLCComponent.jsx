...
// //                           type="text"
// //                           value={
// //                             editEmployeeFields[item.id]?.empId || item.empId
// //                           }
// //                           onChange={(e) =>
// //                             handleNewEmployeeRateChange(
// //                               "empId",
...
// //                           type="text"
// //                           value={
// //                             editEmployeeFields[item.id]?.employeeName ||
// //                             item.employeeName
// //                           }
// //                           readOnly
...
// //                           type="text"
// //                           value={
// //                             editEmployeeFields[item.id]?.plcDescription ||
// //                             item.plcDescription ||
// //                             plcs.find(
// //                               (plc) =>
// //                                 plc.laborCategoryCode ===
// //                                 (editEmployeeFields[item.id]?.plc || item.plc)
// //                             )?.description ||
// //                             ""
// //                           }
// //                           readOnly
...
// //                           <>
// //                             <button
// //                               onClick={() => handleUpdateEmployee(item.id)}
// //                               className="bg-green-500 text-white px-3 py-1 rounded text-xs font-normal hover:bg-green-600 transition w-full sm:w-auto"
// //                               disabled={loading}
// //                             >
// //                               <FaSave className="inline-block mr-1" /> Save
...
// //                     <input
// //                       type="text"
// //                       value={newEmployeeRate.employeeName || ""}
// //                       readOnly
// //                       className="w-full p-1 border rounded text-xs bg-gray-100"
// //                     />
// //                   </td>
...
// //                     <input
// //                       type="text"
// //                       value={newEmployeeRate.plcDescription || ""}
// //                       readOnly
// //                       className="w-full p-1 border rounded text-xs bg-gray-100"
// //                     />
// //                   </td>
...
// //                 <th className="border p-2 font-normal">Vendor</th>
// //                 <th className="border p-2 font-normal">Vendor Name</th>
// //                 <th className="border p-2 font-normal">Vendor Employee ID</th>
// //                 <th className="border p-2 font-normal">Vendor Employee Name</th>
// //                 <th className="border p-2 font-normal">PLC</th>
// //                 <th className="border p-2 font-normal">PLC Description</th>
// //                 <th className="border p-2 font-normal">Bill Rate</th>
...
// //                     </td>
// //                     <td
// //                       className="border p-2 sm:w-1/10"
// //                       style={{ width: "120px" }}
// //                     >
// //                       {editingVendorRowId === item.id ? (
// //                         <select
...
// //                     <input
// //                       type="text"
// //                       value={newVendorRate.plcDescription || ""}
// //                       readOnly
// //                       className="w-full p-1 border rounded text-xs bg-gray-100"
// //                     />
// //                   </td>
...
//   //   if (!dateString) return "";
//   //   // const date = new Date(dateString);
//   //   const localTime = new Date(isoString).toISOString();
//   //   if (isNaN(date.getTime())) return ""; // Handle invalid date strings
//   //   // return date.toLocalString().split("T")[0];
//   //   return localTime;
//   // };
...
// useEffect(() => {
//   fetchBillingRates();
// }, [fetchBillingRates]); // ✅ Only runs when selectedProjectId changes
...
//               <th className="border p-2 font-normal" style={{ width: "150px" }}>Rate Type</th>
//               <th className="border p-2 font-normal" style={{ width: "150px" }}>Start Date</th>
//               <th className="border p-2 font-normal" style={{ width: "150px" }}>End Date</th>
...
//                         }
//                         className="w-full p-2 border rounded text-xs min-w-[120px]"
//                       >
//                         {vendorLookupTypeOptions.map((option) => (
//                           <option key={option} value={option}>
//                             {option}
...
//                         readOnly
//                         className="w-full p-2 border rounded text-xs bg-gray-100 min-w-[120px]"
//                       />
//                     ) : (
