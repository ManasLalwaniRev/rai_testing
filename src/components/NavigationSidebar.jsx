...
// import React, { useState, useEffect } from "react";
// import { Link, useLocation, useNavigate } from "react-router-dom";
// import { Menu, X, ChevronDown, ChevronRight, Plus, LogOut } from "lucide-react"; // <-- ADD LogOut
...
//   // Add Logout handler
//   const handleLogout = () => {
//     // localStorage.removeItem("authToken"); // Uncomment if you use authToken
//     navigate("/login");
//     setIsSidebarOpen(false);
//   };
...
//         {/* ADD LOGOUT BUTTON BELOW THE MENU */}
//         <button
//           className="flex items-center gap-1 mt-8 text-xs sm:text-sm px-2 py-2 w-full rounded-md hover:bg-gray-700 transition-colors duration-150"
