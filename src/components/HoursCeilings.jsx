...
// //           );
// //           setHoursCeilings(res.data?.data || []);
...
//           setIsDataFetched(true);
//         } catch (error) {
//           console.error("Error fetching hours ceilings:", error);
//           setHoursCeilings([]);
//           setIsDataFetched(true);
//         }
//       } else {
...
//       setNewRow({ laborCategory: "", hoursCeiling: "" });
//     } catch (error) {
//       console.error("Error saving hours ceiling:", error);
//       alert("Failed to save. Please check your input and try again.");
//     }
//   };
...
//       setEditRow({});
//     } catch (error) {
//       console.error("Error updating hours ceiling:", error);
//     }
//   };
...
//   useEffect(() => {
//     let isMounted = true; // To handle unmounted component cleanup

//     const fetchHoursCeilings = async () => {
//       // Only proceed if a search has been performed and projectId is valid
//       if (isSearched && isValidProjectId(projectId)) {
//         try {
//           const response = await axios.get(
//             `https://test-api-3tmq.onrender.com/Project/GetAllCeilingHrForPLC?projId=${projectId}`
...
//         }
//       } else if (isMounted) {
//         // Reset data only if no valid search has occurred
//         setHoursCeilings([]);
//         setIsDataFetched(false);
//       }
//       if (isMounted) {
...
//       isMounted = false;
//     };
//   }, [projectId, isSearched]); // Dependency array
...
//       isMounted = false;
//     };
//   }, [isSearched]); // Only trigger on isSearched change
