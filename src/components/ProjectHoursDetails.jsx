...
const handleRowClick = (actualEmpIdx) => {
  ...
  return (
    ...
    //       <div ref={firstTableRef}
    // className="synchronized-table-scroll first"
    ...
    // className="synchronized-table-scroll last"
    // style={{
    //     overflowX: "auto",
    //     overflowY: "auto",              // <-- Only this gets vertical scroll
    //     height: 480,                    // Adjust as you wish
    //     maxHeight: 480,
    //     flex: 1,
    //     minWidth: 0,
    //   }}
    //   onScroll={() => {
    //     // Sync the left table vertical scroll
    //     if (firstTableRef.current && lastTableRef.current) {
    //       firstTableRef.current.scrollTop = lastTableRef.current.scrollTop;
    //     }
    //   }}>
    //         <table className="min-w-full text-xs text-center border-collapse border border-gray-300 rounded-lg">
    //           <thead className="sticky-thead">
