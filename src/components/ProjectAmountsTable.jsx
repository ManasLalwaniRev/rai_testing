...
//         // For EAC plans, retain existing value for closed periods
//         newAmounts[uniqueKey] = newEntryPeriodAmounts[uniqueKey] || '0';
//       } else {
//         // Copy value from source record for editable periods
...
//   //         newAmounts[uniqueKey] = newEntryPeriodAmounts[uniqueKey] || '0';
//   //       } else {
//   //         newAmounts[uniqueKey] = sourceMonthAmounts[uniqueKey]?.value || '0';
//   //       }
//   //     });
//   //   }
...
//               if (newEntry.idType === 'Vendor') {
//                 return {
//                   emplId: emp.vendId, // Map to vendId for Vendor
//                   firstName: '',
//                   lastName: emp.employeeName || '',
//                 };
//               } else if (newEntry.idType === 'Vendor Employee') {
//                 return {
//                   emplId: emp.empId, // Map to empId for Vendor Employee
//                   firstName: '',
//                   lastName: emp.employeeName || '',
//                 };
//               } else {
//                 const [lastName, firstName] = (emp.employeeName || '').split(', ').map(str => str.trim());
//                 return {
//                   emplId: emp.empId, // Map to empId for Employee
//                   firstName: firstName || '',
//                   lastName: lastName || '',
//                 };
//               }
...
//     // plcGlc: emp.emple.plcGlcCode || "",
//     createdBy: emp.emple.createdBy || "System",
//     // createdDate: emp.emple.createdDate || new Date().toISOString(),
//     lastModifiedBy: "System",
...
// //     // notes: emp.emple.notes || "",
// //     category: emp.emple.category || "",
// //     amountType: emp.empl.amountType || "",
// //     id: emp.empl.id || "",
// //     isRev: edited.isRev !== undefined ? edited.isRev : emp.emple.isRev,
// //     isBrd: edited.isBrd !== undefined ? edited.isBrd : emp.emple.isBrd,
// //     // plcGlc: emp.empl.plcGlcCode || "",
// //     createdBy: emp.empl.createdBy || "System",
// //     // createdDate: emp.emple.createdDate || new Date().toISOString(),
// //     lastModifiedBy: "System",
// //     // lastModifiedDate: new Date().toISOString(),
// //     //plForecasts
...
// //       return updated;
// //     });
// //     toast.success("Row updated!", { autoClose: 2000 });
// //   } catch (err) {
// //     toast.error("Failed to update row: " + (err.response?.data?.message || err.message));
// //   }
// // };
...
//                         {EMPLOYEE_COLUMNS.map((col) => {
//   // Editable fields for BUD plan
//   if (isBudPlan && isEditable) {
//     if (col.key === "acctId") {
//       return (
//         <td key={`${uniqueRowKey}-acctId`} className="p-2 border-r border-gray-200 text-xs text-gray-700 min-w-[80px]">
//           <input
//             type="text"
...
//     if (col.key === "orgId") {
//       return (
//         <td key={`${uniqueRowKey}-orgId`} className="p-2 border-r border-gray-200 text-xs text-gray-700 min-w-[80px]">
//           <input
//             type="text"
...
//     if (col.key === "isRev") {
//       return (
//         <td key={`${uniqueRowKey}-isRev`} className="p-2 border-r border-gray-200 text-xs text-gray-700 min-w-[80px] text-center">
//           <input
//             type="checkbox"
...
//     if (col.key === "isBrd") {
//       return (
//         <td key={`${uniqueRowKey}-isBrd`} className="p-2 border-r border-gray-200 text-xs text-gray-700 min-w-[80px] text-center">
//           <input
//             type="checkbox"
...
//     }
//   }
//   // Default: non-editable or non-BUD
//   return (
//     <td key={`${uniqueRowKey}-${col.key}`} className="p-2 border-r border-gray-200 text-xs text-gray-700 min-w-[80px]">
//       {row[col.key]}
//     </td>
//   );
// })}
