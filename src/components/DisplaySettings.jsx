...
const DisplaySettingsContent = () => {
  ...
  const [reportVarianceCalculation, setReportVarianceCalculation] = useState(''); // Default to empty for "Select"

  // NEW states for additional fields from the image
  const [reportHeaderDateFormatOrg, setReportHeaderDateFormatOrg] = useState('01/3109');
  const [reportHeaderDateFormatProject, setReportHeaderDateFormatProject] = useState('JAN-09');
  const [dropdownListDateFormat, setDropdownListDateFormat] = useState('01/3109');
  ...
  const [financialStatementCode, setFinancialStatementCode] = useState('INDSTM');
  ...
  const [includeCostOfMoneyRevenueFee, setIncludeCostOfMoneyRevenueFee] = useState(false);
  const [displayDetailAccounts, setDisplayDetailAccounts] = useState(false);
  const [includePendingApprovedRequisitions, setIncludePendingApprovedRequisitions] = useState(false);
  const [includeUnreleasedBlanketPO, setIncludeUnreleasedBlanketPO] = useState(false);
  const [pendingChangesReportingMethod, setPendingChangesReportingMethod] = useState('Exclude From Total Cost');
  ...
  const handleSaveSettings = useCallback(async () => {
    ...
    budgetHeaderDateFormat, reportVarianceCalculation, reportHeaderDateFormatOrg,
    reportHeaderDateFormatProject, dropdownListDateFormat, reportPrecisionDollar,
    reportPrecisionHour, reportPrecisionPercent, poLagDays, financialStatementCode,
    includeInactiveOrganizations, includeInactiveVendors, includeEmployeeVendors,
    includeVendorEmployees, includeCostOfMoneyRevenueFee, displayDetailAccounts,
    includePendingApprovedRequisitions, includeUnreleasedBlanketPO,
  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex items-center justify-center p-4">
      ...
      <div className="w-full px-8 bg-white rounded-xl shadow-lg p-8 space-y-6 border border-gray-300">
        ...
        <h2 className="w-full  bg-green-50 border-l-4 border-green-400 p-3 rounded-lg shadow-sm mb-4">Display Settings</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 bg-gray-50 p-4 rounded-lg border border-gray-300">
          {/* Left Column Fields */}
          <div className="space-y-4"> {/* No changes to this inner div */}
            {/* Budget Header Date Format (Existing) */}
            <div>
              <label htmlFor="budgetHeaderDateFormat" className="block text-sm font-medium">
                Budget Header Date Format <span className="text-red-500">*</span>
              </label>
              <select
            ...
            <div>
              <label htmlFor="reportHeaderDateFormatOrg" className="block text-sm font-medium">Report Header Date Format - Org</label>
              <input
            ...
            <div>
              <label htmlFor="reportHeaderDateFormatProject" className="block text-sm font-medium">Report Header Date Format - Project</label>
              <select
                id="reportHeaderDateFormatProject"
                value={reportHeaderDateFormatProject}
                onChange={(e) => setReportHeaderDateFormatProject(e.target.value)}
                className="w-full mt-1 border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
            ...
            <div>
              <label htmlFor="dropdownListDateFormat" className="block text-sm font-medium">Drop-Down List Date Format</label>
              <select
            ...
            <div>
              <label htmlFor="reportPrecisionDollar" className="block text-sm font-medium">Report Precision Dollar</label>
              <input
            ...
            <div>
              <label htmlFor="reportPrecisionHour" className="block text-sm font-medium">Report Precision Hour</label>
              <input
            ...
            <div>
              <label htmlFor="reportPrecisionPercent" className="block text-sm font-medium">Report Precision Percent <span className="text-red-500">*</span></label>
              <input
            ...
            {/* PO Lag Days (NEW) */}
            <div>
              <label htmlFor="poLagDays" className="block text-sm font-medium">PO Lag Days <span className="text-red-500">*</span></label>
              <input
                id="poLagDays"
                type="text"
                value={poLagDays}
            ...
            <div>
              <label htmlFor="financialStatementCode" className="block text-sm font-medium">Financial Statement Code <span className="text-red-500">*</span></label>
              <input
            ...
            <div>
              <label htmlFor="reportVarianceCalculation" className="block text-sm font-medium">
                Report Variance Calculation in favor of <span className="text-red-500">*</span>
              </label>
              <select
          ...
          <div className="space-y-4 md:mt-0"> {/* No changes to this inner div */}
            {/* Checkboxes */}
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => setIncludeInactiveOrganizations(e.target.checked)}
                className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
              />
              <label htmlFor="includeInactiveOrganizations" className="text-sm font-medium">Include Inactive Organizations in Lookups and dropdown lists</label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
              />
              <label htmlFor="includeInactiveVendors" className="text-sm font-medium">Include Inactive Vendors in Lookups and dropdown lists</label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
              />
              <label htmlFor="includeEmployeeVendors" className="text-sm font-medium">Include Employee Vendors in Vendor Lookups and dropdown lists</label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
              />
              <label htmlFor="includeVendorEmployees" className="text-sm font-medium">Include Vendor Employees in Vendor Lookups and dropdown lists</label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => setIncludeCostOfMoneyRevenueFee(e.target.checked)}
                className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
              />
              <label htmlFor="includeCostOfMoneyRevenueFee" className="text-sm font-medium">Include Cost of Money Revenue Fee</label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
              />
              <label htmlFor="displayDetailAccounts" className="text-sm font-medium">Display Detail Accounts in Active Level Reports and PSR</label>
            </div>
            ...
            <div className="mt-4">
                ...
                <div className="flex items-center space-x-2 mb-2">
                    <input
                        ...
                        onChange={(e) => setIncludePendingApprovedRequisitions(e.target.checked)}
                        className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
                    />
                    <label htmlFor="includePendingApprovedRequisitions" className="text-sm font-medium">Include Pending/Approved Requisitions</label>
                </div>
                <div className="flex items-center space-x-2">
                    <input
                        ...
                        onChange={(e) => setIncludeUnreleasedBlanketPO(e.target.checked)}
                        className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
                    />
                    <label htmlFor="includeUnreleasedBlanketPO" className="text-sm font-medium">Include Unreleased Blanket PO Amount in Pending</label>
                </div>
            </div>

            {/* Pending Changes Reporting Method (NEW) */}
            <div>
              <label htmlFor="pendingChangesReportingMethod" className="block text-sm font-medium">Pending Changes Reporting Method</label>
              <select
                id="pendingChangesReportingMethod"
                value={pendingChangesReportingMethod}
                onChange={(e) => setPendingChangesReportingMethod(e.target.value)}
                className="w-full mt-1 border border-gray-300 rounded-md shadow-sm py-2 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
