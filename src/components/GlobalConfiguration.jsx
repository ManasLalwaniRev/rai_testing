...
//         const rawValue = (await res.text()).trim(); // 👈 plain string from API
//         let formattedDate = "";
...
//     const fetchEscalationData = async () => {
//       if (!selectedProjectId) {
//         // 🚩 Reset all state when no project is selected
...
//       try {
//         const apiUrl = `https://test-api-3tmq.onrender.com/api/Configuration/GetAllConfigValuesByProject/${selectedProjectId}`;
//         const response = await fetch(apiUrl);
...
//         const configValues = (await response.json()) || [];

//         // ✅ Escalation Month
//         const escalationMonthConfig = configValues.find(
//           (config) => config?.name === "escallation_month"
//         );
//         if (escalationMonthConfig?.value != null) {
//           const matchedMonth = monthOptions.find(
//             (opt) => opt.value === String(escalationMonthConfig.value)
//           );
//           setLaborEscalationMonth(matchedMonth ? matchedMonth.value : "");
//         } else {
//           setLaborEscalationMonth("");
//         }

//         // ✅ Escalation Value
//         const escalationValueConfig = configValues.find(
//           (config) => config?.name === "escallation_percent"
//         );
//         setLaborEscalationValue(
//           escalationValueConfig?.value != null
//             ? escalationValueConfig.value
//             : ""
//         );

//         // ✅ Workforce Rule
//         const workforceConfig = configValues.find(
//           (config) => config?.name === "workforce"
//         );
//         if (workforceConfig?.value != null) {
//           const wfValue =
//             String(workforceConfig.value).toLowerCase() === "true"
//               ? "Enforce"
//               : "Do Not Enforce";
//           setWorkforceRule(wfValue);
//         } else {
//           setWorkforceRule("");
//         }
//       } catch (e) {
...
//   // --- Handle Form Submission (Saving to API) for Project Settings ---
...
//     }
//     console.log(
//       `Attempting to save Project Settings for Project ID: ${selectedProjectId}...`
//     );

//     const updateApiUrl = `${backendUrl}/Project/UpdateConfigValuesByProject/${selectedProjectId}`; // <<<<< IMPORTANT: REPLACE WITH YOUR ACTUAL PUT/POST ENDPOINT

//     // Construct the data payload as per your API's PUT/POST requirement
//     // Convert laborEscalationMonth to a number for the API payload
//     const dataToSave = [
//       {
//         configKey: "LaborEscalationMonth",
//         configValue: Number(laborEscalationMonth),
//       }, // Converted to Number
//       { configKey: "LaborEscalationValue", configValue: laborEscalationValue },
//       // Add other fields from this form that you want to save
//       {
//         configKey: "ProjectBudgetPeriodMethod",
//         configValue: projectBudgetPeriodMethod,
//       },
//       {
//         configKey: "UnlockEACLastClosedPeriod",
//         configValue: unlockEACLastClosedPeriod.toString(),
//       }, // Convert boolean to string if API expects it
//       {
//         configKey: "ProjectAccountGroupCode",
//         configValue: projectAccountGroupCode,
//       },
//       {
//         configKey: "ResourceBudgetCommitFlagDefault",
//         configValue: resourceBudgetCommitFlagDefault.toString(),
//       },
//       { configKey: "AutoPlugCalculation", configValue: autoPlugCalculation },
//       {
//         configKey: "ImportBudgetEACsFromExcelCommitFlagDefault",
//         configValue: importBudgetEACsFromExcelCommitFlagDefault.toString(),
//       },
//       {
//         configKey: "TimesheetImportHistory",
//         configValue: timesheetImportHistory.toString(),
//       },
//       {
//         configKey: "ImportNewBusinessBudgetFromExcelCommitFlag",
//         configValue: importNewBusinessBudgetFromExcelCommitFlag.toString(),
//       },
//       {
//         configKey: "TimesheetScheduleCode",
//         configValue: timesheetScheduleCode,
//       },
//       {
//         configKey: "CheckTheProjectBudgetEnableSubtaskRowHideOptionByDefault",
//         configValue:
//           checkTheProjectBudgetEnableSubtaskRowHideOptionByDefault.toString(),
//       },
//       {
//         configKey: "EnableProjectHideBudEAC",
//         configValue: enableProjectHideBudEAC.toString(),
//       },
//       {
//         configKey: "ShowBudEACOnlyDefault",
//         configValue: showBudEACOnlyDefault.toString(),
//       },
//       {
//         configKey: "ProjectSecurityToBeBasedOn",
//         configValue: projectSecurityToBeBasedOn,
//       },
//       {
//         configKey: "EnableBudgetAutoInspect",
//         configValue: enableBudgetAutoInspect.toString(),
//       },
//       {
//         configKey: "AllowBUDEACCreationPriorToPeriodClose",
//         configValue: allowBUDEACCreationPriorToPeriodClose,
//       },
//       {
//         configKey:
//           "IfLaborSuppressionIsOffDoYouWantToShowEmployeeLaborRatePlanning",
...
//       },
//       {
//         configKey: "DefaultBurdenTemplate",
//         configValue: defaultBurdenTemplate,
//       },
//       {
//         configKey: "ProjectBudgetSequentialLocking",
//         configValue: projectBudgetSequentialLocking.toString(),
//       },
//       { configKey: "WorkforceRule", configValue: workforceRule },
//       { configKey: "OrgLevelDisplay", configValue: orgLevelDisplay.toString() },
//     ];
...
//   }, [
//     selectedProjectId,
//     projectBudgetPeriodMethod,
//     unlockEACLastClosedPeriod,
//     projectAccountGroupCode,
//     resourceBudgetCommitFlagDefault,
//     autoPlugCalculation,
//     importBudgetEACsFromExcelCommitFlagDefault,
//     timesheetImportHistory,
//     importNewBusinessBudgetFromExcelCommitFlag,
//     timesheetScheduleCode,
//     checkTheProjectBudgetEnableSubtaskRowHideOptionByDefault,
//     laborEscalationMonth,
//     enableProjectHideBudEAC,
//     laborEscalationValue,
//     showBudEACOnlyDefault,
//     projectSecurityToBeBasedOn,
//     enableBudgetAutoInspect,
//     allowBUDEACCreationPriorToPeriodClose,
//     ifLaborSuppressionIsOffDoYouWantToShowEmployeeLaborRatePlanning,
//     defaultBurdenTemplate,
//     projectBudgetSequentialLocking,
//     workforceRule,
//     orgLevelDisplay,
//   ]);

//   // --- Handle Saving for Organization Settings ---
//   const handleSaveOrganizationSettings = useCallback(async () => {
//     console.log("Attempting to save Organization Settings...");
//     // Replace with your actual API endpoint for organization settings
//     // Example: const updateApiUrl = `${backendUrl}/Organization/UpdateSettings`;
//     const updateApiUrl = `/api/save-organization-settings`; // Placeholder for your Organization Settings PUT/POST API
...
//     console.log("Organization Settings Data to Save:", orgDataToSave);
...
//           "Content-Type": "application/json",
//         },
//         body: JSON.stringify(orgDataToSave),
//       });
...
//   //       // Find and set Labor Escalation Month and Value from the API response
//   //       const escalationMonthConfig = configValues.find(
//   //         (config) => config.configKey === "LaborEscalationMonth"
//   //       );
//   //       const escalationValueConfig = configValues.find(
//   //         (config) => config.configKey === "LaborEscalationValue"
//   //       );
...
//               className="block text-sm font-medium"
//             >
//               Labor Escalation Month <span className="text-red-500">*</span>
//             </label>
//             <select
//               id="laborEscalationMonth"
//               value={laborEscalationMonth}
...
//               className="block text-sm font-medium"
//             >
//               Labor Escalation Value <span className="text-red-500">*</span>
//             </label>
//             <div className="relative mt-1">
//               {/* <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">
//                 %
...
//                 id="laborEscalationValue"
//                 type="text"
//                 value={laborEscalationValue ? `${laborEscalationValue}%` : ""}
//                 onChange={(e) => {
//                   let val = e.target.value.replace("%", ""); // strip % when typing
//                   handleLaborEscalationValueChange(val);
//                 }}
...
//               disabled={loading || !selectedProjectId}
//             />
//             <label htmlFor="unlockEACLastClosedPeriod" className="text-sm">
//               Unlock EAC Last Closed Period
//             </label>
//           </div>
//           {/* Resource Budget Commit Flag Default */}
...
//               checked={importBudgetEACsFromExcelCommitFlagDefault}
//               onChange={(e) =>
//                 setImportBudgetEACsFromExcelCommitFlagDefault(e.target.checked)
//               }
//               className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
//               disabled={loading || !selectedProjectId}
//             />
...
//               checked={importNewBusinessBudgetFromExcelCommitFlag}
//               onChange={(e) =>
//                 setImportNewBusinessBudgetFromExcelCommitFlag(e.target.checked)
//               }
//               className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
//               disabled={loading || !selectedProjectId}
//             />
...
//               className="text-sm"
//             >
//               Check the Project Budget "Enable Subtask Row Hide" option by
//               default
//             </label>
//           </div>
//           {/* Enable Project "Hide Bud/EAC" */}
...
//               disabled={loading || !selectedProjectId}
//             />
//             <label htmlFor="enableProjectHideBudEAC" className="text-sm">
//               Enable Project "Hide Bud/EAC"
//             </label>
//           </div>
//           {/* Show Budget/EAC Only Default */}
...
//               disabled={loading || !selectedProjectId}
//             />
//             <label htmlFor="enableBudgetAutoInspect" className="text-sm">
//               Enable Budget Auto Inspect
//             </label>
//           </div>
//           {/* Project Budget Sequential Locking */}
...
//               disabled={loading || !selectedProjectId}
//             />
//             <label htmlFor="projectBudgetSequentialLocking" className="text-sm">
//               Project Budget Sequential Locking
//             </label>
//           </div>
//         </div>
...
//         setClosingPeriod(/^\d{4}-\d{2}-\d{2}$/.test(rawValue) ? rawValue : "");
//       } catch (err) {
//         console.error("Error fetching closing period:", err);
//         setClosingPeriod("");
//       } finally {
...
//               className="block text-sm font-medium"
//             >
//               Holiday Expense Account <span className="text-red-500">*</span>
//             </label>
//             <input
//               id="holidayExpenseAccount"
//               type="text"
...
//               className="block text-sm font-medium"
//             >
//               PTO Calculation Method <span className="text-red-500">*</span>
//             </label>
//             <select
//               id="ptoCalculationMethod"
//               value={ptoCalculationMethod}
...
//               className="block text-sm font-medium"
//             >
//               Default PTO Accrual Rate <span className="text-red-500">*</span>
//             </label>
//             <input
//               id="defaultPtoAccrualRate"
//               type="text"
...
//               className="block text-sm font-medium"
//             >
//               Default Utilization % <span className="text-red-500">*</span>
//             </label>
//             <input
//               id="defaultUtilization"
//               type="text"
...
//               className="block text-sm font-medium"
//             >
//               Labor Expense Org Level(s) <span className="text-red-500">*</span>
//             </label>
//             <input
//               id="laborExpenseOrgLevels"
//               type="text"
...
//               className="block text-sm font-medium"
//             >
//               NLAB $ History Method <span className="text-red-500">*</span>
//             </label>
//             <select
//               id="nlabHistoryMethod"
//               value={nlabHistoryMethod}
...
//               className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
//             />
//             <label htmlFor="updateEmployeeAccrualRate" className="text-sm">
//               Update Employee Accrual Rate
//             </label>
//           </div>
//           {/* Apply % Probability to New Business Budgets */}
...
//               checked={applyProbabilityToNewBusinessBudgets}
//               onChange={(e) =>
//                 setApplyProbabilityToNewBusinessBudgets(e.target.checked)
//               }
//               className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
//             />
//             <label
...
//               className="rounded-md h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300"
//             />
//             <label htmlFor="orgBudgetSequentialLocking" className="text-sm">
//               Org Budget Sequential Locking
//             </label>
//           </div>
//         </div>
...
//     } else if (
//       activeTab === "OrganizationSettings" &&
//       organizationSettingsSaveRef.current
//     ) {
//       await organizationSettingsSaveRef.current(); // Corrected to use .current()
//     }
//   };
...
//         <div>
//           {activeTab === "projectSettings" && (
//             <LaborFormContent onSave={projectSettingsSaveRef} />
//           )}
//           {activeTab === "OrganizationSettings" && (
//             <NewTabContent onSave={organizationSettingsSaveRef} />
//           )}
//         </div>
...
const LaborForm = () => {
  ...
  //       setConfigValues(fetchedConfigValues); // ✅ save to state

  //       // Escalation Month
  //       const escalationMonthConfig = fetchedConfigValues.find(
  //         (config) => config?.name === "escallation_month"
  //       );
  //       setLaborEscalationMonth(
  //         escalationMonthConfig?.value != null
  //           ? escalationMonthConfig.value
  //           : ""
  //       );

  //       // Escalation Value
  //       const escalationValueConfig = fetchedConfigValues.find(
  //         (config) => config?.name === "escallation_percent"
  //       );
  //       setLaborEscalationValue(
  //         escalationValueConfig?.value != null
  ...
  //   const updateApiUrl = `${backendUrl}/api/Configuration/UpdateConfigValues`; // <<<<< IMPORTANT: REPLACE WITH YOUR ACTUAL PUT/POST ENDPOINT
  ...
  //       value: laborEscalationMonth, // e.g., "5"
  ...
  //       value: laborEscalationValue, // e.g., "2.5"
  //       createdAt: nowIsoString,
  //       projId: selectedProjectId,
  //     },
  //     // Repeat for other config keys:
  //     {
  //       id: 0,
  //       name: "workforce",
  //       value: workforceRule === "Enforce" ? "true" : "false", // if API expects string for boolean
  //       createdAt: nowIsoString,
  //       projId: selectedProjectId,
  //     },
  //   ];
  ...
  //     alert("No configuration data loaded for this project.");
  //     return;
  //   }
  ...
  //   // Map existing configValues and update only relevant fields
  //   const dataToSave = configValues
  //     .filter((config) =>
  //       ["escallation_month", "escallation_percent", "workforce"].includes(
  //         config.name
  //       )
  //     )
  //     .find((config) => {
  ...
  //         newValue = laborEscalationMonth ?? "0";
  //       if (config.name === "escallation_percent")
  //         newValue = laborEscalationValue ?? "0";
  //       if (config.name === "workforce") {
  //         // Store as boolean string "true"/"false" if your backend expects it
  //         newValue =
  //           workforceRule === "Enforce"
  //             ? "true"
  //             : workforceRule === "Do Not Enforce"
  //             ? "false"
  //             : config.value;
  //       }
  ...
  //   console.log(
  //     "Prepared Payload for UpdateConfigValues API:",
  ...
  //     alert(`Error saving project settings: ${error.message}`);
  //   }
  // }, [
  //   laborEscalationMonth,
  //   laborEscalationValue,
  ...
  const handleSaveProjectSettings = useCallback(async () => {
    ...
    // Prepare payload using configValues from state
    const dataToSave = configValues.map((config) => {
      let newValue = config.value;
  ...
  const handleSaveOrganizationSettings = useCallback(async () => {
    ...
    const closingPeriodPayload = {
      id: "0", // 0 = let backend assign, or use existing id if you fetched it
      name: "closing_period",
  ...
  }, [closingPeriod, selectedProjectId]);
